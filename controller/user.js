    ...
    try {
        ...
        for (const handler of handlers) {
            if (handler.daysLeft > 0) {
                ...
                // Send Email Reminder
                const emailHtml = `
          <h2>globalprovest Deposit Reminder</h2>
        ...
        `;
                ...
                await resend.emails.send({
                    ...
                    to: user.email,
                    subject: 'Deposit Reminder - globalprovest',
                    html: emailHtml
                });
...
module.exports.login = async (req, res, next) => {
    ...
    try {
        ...
        if (!userExist.isEmailVerified) {
            ...
            <html>
            <body>
                <h2>globalprovest Verification</h2>
...
module.exports.signup = async (req, res, next) => {
    ...
    <body style="font-family: Arial, sans-serif; line-height:1.6;">
        <h2>Welcome to globalprovest </h2>
        
        <p>Hello <strong>${email}</strong>,</p>
        
        <p>
        We're excited to welcome you to <b>globalprovest</b>. Your account has been successfully created 
        and you are now part of our growing financial community.
        </p>

        <p>
        With globalprovest, you can securely manage your finances, explore investment opportunities, 
...
module.exports.verifyEmail = async (req, res, next) => {
    ...
    try {
        ...
        const welcomeEmailTemplate = (name) => `
            ...
            <body>
                <div class="container">
                    <h2>Welcome to globalprovest, ${name}!</h2>
                    <p>We're excited to have you onboard. Your email has been successfully verified, and your journey with globalprovest begins now.</p>
                    ...
                    <br/>
                    <p>Warm regards,</p>
                    <p><strong>globalprovest Team</strong></p>
                </div>
            </body>
            </html>
        `;
        ...
        try {
            const emailResponse = await resend.emails.send({
                from: 'globalprovest@globalprovest.xyz',
                to: email,
                subject: 'Welcome to globalprovest!',
    ...
    try {
        ...
        await resend.emails.send({
            ...
            html: `
                ...
                <head>
                  <meta charset="UTF-8" />
                  <title>globalprovest Registration Success</title>
                  <style>
                    body {
                ...
                <body>
                  <div class="container">
                    <h2>globalprovest Registration Complete</h2>
                    <p>Dear ${firstName} ${lastName},</p>
                    <p>Your profile registration on globalprovest has been successfully completed and verified.</p>
                    ...
                    <div class="footer">
                      <p>Thank you for using globalprovest.</p>
                    </div>
                  </div>
                </body>
                </html>
        ...
        let notification = {
            ...
            body: 'Your profile registration on globalprovest has been successfully completed and verified'
        };
...
module.exports.createDeposit = async (req, res, next) => {
    try {
        ...
        await resend.emails.send({
            from: 'globalprovest@globalprovest.xyz',
            to: foundUser.email,
            subject: 'Deposit Initiated – globalprovest',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background-color: #fff; border-radius: 8px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <p style="margin-top: 30px;">Thank you for choosing <strong>globalprovest</strong>.</p>
                </div>
            `
        });
...
module.exports.createWithdraw = async (req, res, next) => {
    try {
        ...
        await resend.emails.send({
            from: 'globalprovest@globalprovest.xyz',
            to: foundUser.email,
            subject: 'Withdrawal Request Received – globalprovest',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background-color: #fff; border-radius: 8px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <p style="margin-top: 30px;">Thank you for using <strong>globalprovest</strong>.</p>
                </div>
            `
        });
